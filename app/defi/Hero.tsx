          ...
          <div className='flex justify-between'>
            <div className='relative'>
              ...
              <p className='text-neonGreen-500 text-xs md:text-sm font-semibold md:font-bold mb-4 md:mb-2'>
                $80,000,000+ bridged to Etherlink to date
              </p>
              <h1
            ...
            -tracking-[0.72px] md:-tracking-[1.12px] md:max-w-[600px] mb-5 md:mb-2'
              ...
              <img
                className='absolute -bottom-[200px] md:-bottom-[500px] -left-[200px] md:-left-[150px] max-w-[960px] max-h-[960px] md:opacity-100 z-[50] pointer-events-none'
