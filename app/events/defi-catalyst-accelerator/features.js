...
export default function Features() {
  return (
    <div className='py-12'>
      <div className='flex flex-col w-4/5 mx-auto max-w-screen-2xl'>
        <div className='mb-20 w-max-auto md:w-3/4 text-center self-center'>
        ...
        <div className='mt-20'>
          ...
          <div className='mt-5'>
            <p className='text-2xl mt-10'>
              Through the DCA we want to bring to the community on-chain
              projects with a financial angle. This might include but is not
...
const Box = ({ title, text }) => {
  return (
    <div className='p-8 rounded-2xl bg-neutral-800 shadow-md shadow-slate-400/40 hover:shadow-lg hover:shadow-darkGreen'>
      <h2 className='text-2xl leading-normal text-darkGreen text-center mb-6'>
        {title}
      </h2>
      <p className='text-lg leading-normal text-center'>{text}</p>
    </div>
  )
}
