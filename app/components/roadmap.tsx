...
const milestones = [
  {
    ...
    cardSubtitle: '',
    cardDetailedText: [
      '- Testnet Latency Improvements',
      '- Etherlink Infra Ecosystem',
      '- Builders Program Launch',
      '- Etherlink Quests Launch',
      '- Mainnet Open Beta'
    ]
  },
  {
    ...
    cardSubtitle: '',
    cardDetailedText: [
      '- Etherlink Incubator Kick-off',
      '- Ambassador Program Launch',
      '- Etherlink Hackathon',
      '- Audits finalized for the Etherlink Kernel & Sequencer',
      '- Etherlink Ecosystem & Partner Expansion '
    ]
  },
  {
    title: 'Q3 2024',
